...
const apiConfig = {
    ...
    simulation: {
        ...
        studentComplete: {
            baseURL: `${apiUrl}v1/student/complete-list`,
            method: `GET`,
            headers: baseHeader,
    ...
    taskQuestionProgress: {
        answerList: {
            baseURL: `${apiUrl}v1/task-question-progress/answer-list`,
            method: 'GET',
            headers: baseHeader,
    ...
    review: {
        ...
        // Nếu vẫn cần client-list thì anh thêm vào
        getListForClient: {
    ...
    notification: {
        ...
        getListByStudent: {
            baseURL: `${apiUrl}v1/notification/student-list`,
            method: 'GET',
            headers: baseHeader,
